      ...
      <footer className="bg-gray-900 text-gray-400 py-12 px-4 mt-8">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/tool/upsc" className="hover:text-white transition-colors">UPSC Photo Resizer</Link></li>
              <li><Link href="/tool/upsc-signature" className="hover:text-white transition-colors">UPSC Signature Resizer</Link></li>
