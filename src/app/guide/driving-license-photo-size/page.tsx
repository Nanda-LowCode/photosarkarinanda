        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/guide/driving-license-photo-size" className="transition-colors" style={{ color: "rgba(255,255,255,0.45)" }}>Driving Licence Photo Size</Link></li>
              <li><Link href="/guide/voter-id-photo-size" className="transition-colors" style={{ color: "rgba(255,255,255,0.45)" }}>Voter ID Photo Size</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/tool/driving-license" className="transition-colors" style={{ color: "rgba(255,255,255,0.45)" }}>Driving Licence Photo Resizer</Link></li>
              <li><Link href="/tool/voter-id" className="transition-colors" style={{ color: "rgba(255,255,255,0.45)" }}>Voter ID Photo Resizer</Link></li>
