        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/guide/railway-rrb-photo-resize" className="transition-colors" style={{ color: "rgba(255,255,255,0.45)" }}>Railway RRB Photo Size</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/tool/railway-exam" className="transition-colors" style={{ color: "rgba(255,255,255,0.45)" }}>Railway Photo Resizer</Link></li>
              <li><Link href="/tool/ssc-exam" className="transition-colors" style={{ color: "rgba(255,255,255,0.45)" }}>SSC Photo Resizer</Link></li>
