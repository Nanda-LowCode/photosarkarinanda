      ...
      <footer className="py-10 px-4 mt-8" style={{ background: "var(--navy)", color: "rgba(255,255,255,0.45)" }}>
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/tool/ibps-bank" className="transition-colors" style={{ color: "rgba(255,255,255,0.45)" }}>IBPS Photo Resizer</Link></li>
              <li><Link href="/tool/ibps-signature" className="transition-colors" style={{ color: "rgba(255,255,255,0.45)" }}>IBPS Signature Resizer</Link></li>
